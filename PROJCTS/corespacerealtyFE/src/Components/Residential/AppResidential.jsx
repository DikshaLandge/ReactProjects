...
import ResidentialHomepageCard from "./ResidentialHomepageCard";
...
const AppResidential = () => {
  ...
  let [ide, setIde] = useState("0");
   ...
   const selectedCard = (id) => {
    ...
    console.log( "hello state",ide);

  };
console.log(ide);
  // useEffect(() => {
  //   console.log("hello render", ide);
  // }, [ide]);

   const fetchUserData = async() => {
    await fetch("http://localhost:4000/api/property/properties")
      .then(response => {
...
useEffect(()=>{
  ...
  const currentOutput2 = products.slice(firstPostIndex, lastPostIndex);
      ...
      <div className="b-slate-100">
        <div className="relative w-full h-[600px] px-6 overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
            ...
            {/* <h1 className="text-5xl font-bold text-center" style={{ animation: 'slideInFromLeft 1s ease-in-out forwards', animationDelay: 's' }}>Residential Properties</h1> */}
            <h1
        ...
        <div className="flex flex-row flex-wrap justify-center gap-4 items-center p-5 ">
          {currentOutput2.map((card) => (
            <div key={card.id} className="">
              {/* <ResidentialHomepageCard data2={card} /> */}
              {/* card start */}
        ...
        <div className="flex flex-col text-lg text-gray-600 ">
          ...
          <div className=" items-center">
            ...
            <div className="flex items-center mr-4">
              ...
              <span className="ml-2 mt-2"> {card.location}</span>
            </div>
            ...
            <div className="flex items-center mr-4">
              ...
              <span className="ml-2 mt-1">{card.homeArea}</span>
            </div>
            ...
            <div className="flex items-center mr-4">
              ...
              <span className="ml-2 mt-1"> {card.lotDimentions}</span>
            </div>
          </div>

          <div className="flex mt-6">
            <div>
              <span className="">{card.yearBuilt} </span>

              <Link to={`/Appresidential/ViewDetail`}>
                <button
                  onClick={(e)=>setIde(e.target.value)}
                  value={card.propertyID}
...
export default memo(AppResidential);
